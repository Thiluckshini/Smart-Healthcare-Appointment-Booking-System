...
{ ?>
	...
	<button class="btn btn-success btn-xs" onclick='generatePDF(<?php echo json_encode($row); ?>)'>View PDF</button>
	<?php } else {
...
<script>
  async function generatePDF(data) {
    ...
    doc.save(`appointment_${data.id}.pdf`);
  }
</script>
